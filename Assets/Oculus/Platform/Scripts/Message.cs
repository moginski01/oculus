...
namespace Oculus.Platform
{
    public abstract class Message<T> : Message
    {
        ...
        {
            if (!IsError) Data = GetDataFromMessage(c_message);
        }
    ...
    public class Message
    {
        ...
        public Message(IntPtr c_message)
        {
            ...
            if (!isError)
            {
                ...
                {
                    var errorHandle = CAPI.ovr_Message_GetError(msg);
                    error = new Error(
        ...
        {
            if (messageHandle.ToInt64() == 0) return null;
            ...
            switch (message_type)
            {
                ...
                default:
                    ...
                    if (message == null) Debug.LogError(string.Format("Unrecognized message type {0}\n", message_type));
                    break;
    ...
    public class MessageWithPingResult : Message<PingResult>
    {
        ...
        protected override PingResult GetDataFromMessage(IntPtr c_message)
        {
            ...
            var is_timeout = CAPI.ovr_PingResult_IsTimeout(ping);
            return new PingResult(
                CAPI.ovr_PingResult_GetID(ping),
                is_timeout ? null : CAPI.ovr_PingResult_GetPingTimeUsec(ping)
            );
        }
    }

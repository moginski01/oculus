...
namespace Oculus.Platform
{
    public static class PlatformInternal
    {
        ...
        public enum MessageTypeInternal : uint
        {
            ...
            DeviceApplicationIntegrity_GetAttestationToken = 0x102FA3DE,
        ...
        public static Request<PlatformInitialize> InitializeStandaloneAsync(ulong appID, string accessToken)
        {
            ...
            if (initRequest == null) throw new UnityException("Oculus Platform failed to initialize.");
        ...
        public static class Users
        {
            public static Request<LinkedAccountList> GetLinkedAccounts(ServiceProvider[] providers)
            {
                if (Core.IsInitialized())
                {
                    ...
                    foreach (var provider in providers) userOpts.AddServiceProvider(provider);
                    return new Request<LinkedAccountList>(CAPI.ovr_User_GetLinkedAccounts((IntPtr)userOpts));
                }
